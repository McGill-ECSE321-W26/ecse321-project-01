...
public class ClothingServiceTests {
    ...
    public void testGetClothingModelByInvalidId() {
        ...
        ResponseStatusException e =
                assertThrows(ResponseStatusException.class, () -> clothingService.getClothingModel(modelId));
        assertEquals("404 NOT_FOUND \"Clothing model with ID " + modelId + " not found\"", e.getMessage());
    }
    ...
    public void testCreateClothingModelWithInvalidName() {
        ...
        //ACT & ASSERT
        ResponseStatusException e =
                assertThrows(ResponseStatusException.class, () -> clothingService.createClothingModel(null, price));
    ...
    public void testCreateClothingModelWithBlankName() {
        ResponseStatusException e = assertThrows(ResponseStatusException.class,
                ()-> clothingService.createClothingModel("  ", 100f));
        assertEquals("400 BAD_REQUEST \"Name must not be blank\"", e.getMessage());
    }
    ...
    public void testCreateClothingModelWithInvalidPrice () {
        ...
        ResponseStatusException e =
                assertThrows(ResponseStatusException.class, () -> clothingService.createClothingModel(name, price));
    ...
    public void testGetVariantById() {
        ...
        ClothingVariant variant = new ClothingVariant(variantId, ClothingVariant.Size.M, "Red", 10, model);
        when(clothingVariantRepository.findByClothingVariantID(variantId)).thenReturn(variant);

        // Act
        ClothingVariant result = clothingService.getVariant(variantId);
    ...
    public void testGetVariantByInvalidId() {
        ...
        // Act & Assert
        ResponseStatusException e = assertThrows(ResponseStatusException.class,
                () -> clothingService.getVariant(variantId));
        assertEquals("404 NOT_FOUND \"Clothing variant with ID " + variantId + " not found\"", e.getMessage());
    }
    ...
    public void testGetVariantsByModel() {
        ...
        ClothingVariant variant = new ClothingVariant("variant1", ClothingVariant.Size.M, "Red", 10, model);
        when(clothingModelRepository.findByClothingModelID(modelId)).thenReturn(model);
    ...
    public void testGetVariantsByInvalidModel() {
        ...
        // Act & Assert
        ResponseStatusException e = assertThrows(ResponseStatusException.class,
                () -> clothingService.getVariantsByModel(modelId));
        assertEquals("404 NOT_FOUND \"Clothing model with ID " + modelId + " not found\"", e.getMessage());
    }
    ...
    public void testCreateValidVariant() {
        ...
        String modelId = "model1";
        ClothingModel model = new ClothingModel(modelId, "Summer Jacket", 79.99f);
        ClothingVariant saved = new ClothingVariant(null, ClothingVariant.Size.L, "Blue", 5,
        ...
        // Act
        ClothingVariant result = clothingService.createVariant(modelId, ClothingVariant.Size.L, "Blue", 5);
    ...
    public void testCreateVariantWithDuplicateSizeAndColor() {
        ...
        ResponseStatusException e = assertThrows(ResponseStatusException.class,
                () -> clothingService.createVariant(modelId, ClothingVariant.Size.M, "Red", 5));
        assertEquals("409 CONFLICT \"A variant with size M and color Red already exists for this clothing model\"",
                e.getMessage());
    }
    ...
    public void testDeleteVariantWithInvalidId() {
        // Arrange
        String variantId = "badVariant";
        when(clothingVariantRepository.deleteByClothingVariantID(variantId)).thenReturn(0);
    ...
    public void testUpdateValidVariant() {
        ...
        ClothingVariant variant = new ClothingVariant(variantId, ClothingVariant.Size.M, "Red", 10, model);
        when(clothingVariantRepository.findByClothingVariantID(variantId)).thenReturn(variant);
        when(clothingVariantRepository.save(any(ClothingVariant.class))).thenAnswer(i -> i.getArgument(0));
