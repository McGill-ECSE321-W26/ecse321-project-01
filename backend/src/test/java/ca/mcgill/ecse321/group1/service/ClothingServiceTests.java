...
public class ClothingServiceTests {
    ...
    public void testGetVariantByInvalidId() {
        ...
        // Act & Assert
        ResponseStatusException e =
                assertThrows(ResponseStatusException.class, () -> clothingService.getVariant(variantId));
        assertEquals(
    ...
    public void testDeleteVariantWithInvalidId() {
        ...
        // Act & Assert
        ResponseStatusException e =
                assertThrows(ResponseStatusException.class, () -> clothingService.deleteVariant(variantId));
        assertEquals(
                "404 NOT_FOUND \"Clothing variant with ID " + variantId + " not found\"", e.getMessage());
    }
